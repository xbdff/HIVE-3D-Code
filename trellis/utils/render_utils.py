...
def render_video(sample, resolution=1024, bg_color=(255, 255, 255), num_frames=300, r=2, fov=40, **kwargs):
    yaws = torch.linspace(0, 2 * 3.1415, num_frames)
    pitch = 0.25 + 0.5 * torch.sin(torch.linspace(0, 2 * 3.1415, num_frames))
    # Use a fixed 60-degree pitch.
    #pitch_degrees = 13.0
    #pitch_radians = pitch_degrees * (3.1415 / 180.0)
    #pitch = torch.full_like(yaws, pitch_radians) # Match the shape of yaws.
    yaws = yaws.tolist()
    pitch = pitch.tolist()
