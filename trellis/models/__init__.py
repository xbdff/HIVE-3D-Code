...
__attributes = {
    ...
    'IPAdapterSparseStructureFlowModel': 'sparse_structure_flow',

    'LatentProjector': 'ip_adapter_modules',
...
if __name__ == '__main__':
    ...
    from .sparse_structure_flow import SparseStructureFlowModel,IPAdapterSparseStructureFlowModel

    from .ip_adapter_modules import LatentProjector
